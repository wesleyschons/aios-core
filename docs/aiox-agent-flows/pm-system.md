...
| Arquivo | Propósito |
|---------|-----------|
| `.aiox-core/development/agents/pm.md` | Definição core do agente PM |
...
| `.aiox-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
...
| Arquivo | Propósito |
|---------|-----------|
| `.aiox-core/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
